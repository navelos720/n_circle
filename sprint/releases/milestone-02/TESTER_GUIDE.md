...
2. Navigate to the `sprint/` folder (or your release folder).
...
2. **Copy Extension Files**:
   ...
   - Copy the folder `sprint/ae-radial-plugin` (or the contents of `releases/milestone-02/`) into this directory and rename the folder to:  
